...
public class FinalUpdateDAO {
	...
	private static final String  QUERY="update user set fname=?,lname =?,mail =?,gender=?,dob=?,mobno=?,company=?,city=?,addr=? WHERE fname =?";
	public int updateUserDetails(HttpServletRequest req,UserBean u)
	{
		int k=0;
		try
		{
